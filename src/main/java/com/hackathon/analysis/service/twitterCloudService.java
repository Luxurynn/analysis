...
import com.hackathon.analysis.repository.twitterCloudRepository;
...
@Service
public class twitterCloudService {
    ...
    @Autowired
    twitterCloudRepository twitterCloudRepository;
...
//    HighLightJestSearchResultMapper jestSearchResultMapper;
    ...
    public Page<twitterCloud> searchCloud(Integer pNum, Integer pSize, String keywords) {
        // 校验分页参数
        ...
        */
        ...
        FunctionScoreQueryBuilder.FilterFunctionBuilder[] functions = {
                new FunctionScoreQueryBuilder.FilterFunctionBuilder(
                        matchPhraseQuery("text", searchContent),
